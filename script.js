...
// figlet("Ayush", function (err, data) {
//   if (err) {
...
//   readFile
// fs.readFile("math.txt","utf8",(err, data)=>{
//     if(err){
...
// fs.writeFile("text.txt","hello bachhoooooooooo",(err)=>{
//     if(err){
//         console.log(err);
//     }else{
...
// update 
// fs.appendFile("text.txt","hello students",(err)=>{
//     if(err){
//         console.log(err);
//     }else{
...
// remane
// fs.rename("app.js","server.js",(err)=>{
//     if(err){
//         console.log(err);
